package com.tech.pwds.boot.filter;
...
import com.tech.pwds.boot.utilities.StringUtils;
...
public class BootFilter implements Filter {
	private static final Logger LOG = LoggerFactory.getLogger(BootFilter.class);
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain filterChain)
		...
		response.setHeader("Access-Control-Allow-Headers",
				"Content-Type,X-Requested-With,accept,Origin,Access-Control-Request-Method,Access-Control-Request-Headers,Authorization,companyId,id,token");
